...
import 'package:peruri_app/presentation/pages/news_page/most_popular_page.dart'
    as _i9;
import 'package:peruri_app/presentation/pages/news_page/news_page.dart' as _i12;
...
class TransformSignatureRoute extends _i13.PageRouteInfo<void> {
  const TransformSignatureRoute({List<_i13.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i3.SignaturePage]
class SignatureRoute extends _i13.PageRouteInfo<void> {
  const SignatureRoute({List<_i13.PageRouteInfo>? children})
      : super(
          SignatureRoute.name,
          initialChildren: children,
        );
...
class DummyUIPartOneRoute extends _i13.PageRouteInfo<void> {
  const DummyUIPartOneRoute({List<_i13.PageRouteInfo>? children})
      : super(
...
class DummyUIPartTwoRoute extends _i13.PageRouteInfo<void> {
  const DummyUIPartTwoRoute({List<_i13.PageRouteInfo>? children})
      : super(
...
class AARIntegrationRoute extends _i13.PageRouteInfo<void> {
  const AARIntegrationRoute({List<_i13.PageRouteInfo>? children})
      : super(
...
class CalculatorRoute extends _i13.PageRouteInfo<void> {
  const CalculatorRoute({List<_i13.PageRouteInfo>? children})
      : super(
...
class TopStoriesCategoriesRoute extends _i13.PageRouteInfo<void> {
  const TopStoriesCategoriesRoute({List<_i13.PageRouteInfo>? children})
      : super(
