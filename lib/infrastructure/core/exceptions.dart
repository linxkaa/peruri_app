...
class SharedPreferencesException extends DefaultException {
  SharedPreferencesException([String? message]) : super(message ?? "Shared Preferences Error");
}
...
class UnprocessableEntityException extends ApiResponseException {
  UnprocessableEntityException(ApiResponseModel model) : super("Unprocessable Entity Error:", model);
}
